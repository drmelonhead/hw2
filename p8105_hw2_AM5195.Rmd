...
Then use the same inline code to figure out that there are `r nrow(distinct(train_ada_df,station_name,route1,route2,route3,route4,route5,route6,route7,route8,route9,route10,route11))` distinct ADA compliant stations. 
