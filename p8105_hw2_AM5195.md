...
vending allow entrance? I created a data frame that only includes
station without vending:
...
Then I calculated the that the proportion of these stations that allow
allow enty is 0.38.
